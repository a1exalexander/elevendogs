  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.barbers}>
        <Link href={Routes.MAIN} className={clsx(styles.barber, styles.isMain)}>
        ...
        <Link href={Routes.SECONDARY} className={clsx(styles.barber, styles.isSecondary)}>
          <div className={styles.image}>
            <Image
              priority
              src={imageSecondary}
      ...
      <footer className={styles.footer}>
        <nav className={styles.nav}>
          <Link href={Routes.EDUCATION} className={styles.link}>
            Навчання{' '}
            <svg
